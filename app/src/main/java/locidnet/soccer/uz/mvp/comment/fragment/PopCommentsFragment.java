...
public class PopCommentsFragment extends BaseFragment {
    ...
    private static PopCommentsFragment mInstance;


    public static PopCommentsFragment getInstance() {
        if (mInstance == null) mInstance = new PopCommentsFragment();
        return mInstance;
    }
    public static PopCommentsFragment getInstance(Bundle data) {
        if (mInstance == null) mInstance = new PopCommentsFragment();
    ...
    public String getTitle() {
        return Base.context().getString(R.string.popularComment);
    }
}
